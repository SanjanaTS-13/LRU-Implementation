...
char res[] = "Number of Page faults =  ";

float bgcolor[][3] = { {0.7,0,0.7},{0,1,0},{0,0,1} };
int bgpointer = 0;
float tilecolor[][3] = { {0.9,0,0.5},{1,0.7,0.7},{0,1,1} };
int tilepointer = 0;
void* fonts[] =
{
GLUT_BITMAP_9_BY_15,
...
void front_page()
{
	...
	//output(400, 450, " Ujire ", 2);
	output(240, 400, "Subject: Computer Graphics (18CSL68)", 2);
	//output(320, 350, " B ", 2);
	output(280, 300, "MINI PROJECT", 2);

	output(220, 250, "LRU PAGE REPLACEMENT ALGORITHM", 2);
	output(100, 150, "Guide:", 3);
	output(135, 130, "Mr.Raghavendra Patil G E", 5);
	//output(135, 100, "Mr.Chinthesh", 5);

	output(450, 150, "By:", 3);
	output(475, 130, "RANJITHA P R [4SU18CS072]", 5);
	output(475, 100, "SANJANA T S [4SU18CS077]", 5);
...
void display()
{
	...
	drawText("Implementation Of LRU Algorithm", 250, 550, 0);
...
{
	glutInit(&argc, argv);
	//printf("**************************COMPUTER GRAPHICS MINIPROJECT**************************\n");
	//printf("*************************IMPLEMENTATION OF LRU ALGORITHM*************************\n\nBY:\n1.Ranjitha P R\n2.Sanjana T S\n\n\n");
	int i;
	...
	glutCreateWindow("LRU Replacement");
